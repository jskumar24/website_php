                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="plans/add_plan.php">Add
                                        Plan</a></li>
                                <li class="nav-item"> <a class="nav-link" href="plans/edit_plan.php">Edit
                                        Plan</a></li>
                                <li class="nav-item"> <a class="nav-link"
                                        href="plans/delete_plan.php">Delete Plan</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
